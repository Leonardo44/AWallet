...
public class EarningCategoryAdapter extends ArrayAdapter<EarningCategory>  {
    public EarningCategoryAdapter(Context context, ArrayList<EarningCategory> colorList) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        EarningCategory currentItem = getItem(position);
