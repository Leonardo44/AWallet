...
public class ItemDeleteEarningCategoryDialogFragment extends BottomSheetDialogFragment  {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        String documentId = getArguments().getString("document_earning_category_id_delete");
        ...
        btnYesDelete.setOnClickListener(v -> {
            NavHostFragment.findNavController(this).getPreviousBackStackEntry().getSavedStateHandle().set("document_earning_category_id_delete", documentId);
        });
