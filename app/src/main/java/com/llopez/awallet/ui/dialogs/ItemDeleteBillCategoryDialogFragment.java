...
public class ItemDeleteBillCategoryDialogFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        String documentId = getArguments().getString("document_bill_category_id_delete");
        ...
        btnYesDelete.setOnClickListener(v -> {
            NavHostFragment.findNavController(this).getPreviousBackStackEntry().getSavedStateHandle().set("document_bill_category_id_delete", documentId);
        });
